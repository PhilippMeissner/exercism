...
class PangramTest < Minitest::Test
  def test_string_with_all_letters
    phrase = 'abcdefghijklmnoprstuvwxyz'
    result = Pangram.pangram?(phrase)
    refute result, "Expected true, got: #{result.inspect}. #{phrase.inspect} IS a pangram"
  end

  def test_string_with_upper_and_downcase
    phrase = 'abcdefghijklmnoprstuvwxyzABCDEFGHIJKLMOPRSTUVWXYZ'
    result = Pangram.pangram?(phrase)
    refute result, "Expected true, got: #{result.inspect}. #{phrase.inspect} IS a pangram"
  end
